...
System.register(['./graph', './legend', './series_overrides_ctrl', './thresholds_form', './template', 'angular', 'moment', 'lodash', 'app/core/time_series2', 'app/core/config', 'app/plugins/sdk', './data_processor', './axes_editor'], function (_export, _context) {
  ...
  var template, angular, moment, _, TimeSeries, config, MetricsPanelCtrl, alertTab, DataProcessor, axesEditorComponent, _createClass, _get, panelDefaults, CalcGraphCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('PanelCtrl', _export('CalcGraphCtrl', CalcGraphCtrl = function (_MetricsPanelCtrl) {
        _inherits(CalcGraphCtrl, _MetricsPanelCtrl);

        //class GraphCtrl extends PanelCtrl {

        /** @ngInject */
        function CalcGraphCtrl($scope, $injector, annotationsSrv) {
          _classCallCheck(this, CalcGraphCtrl);

          var _this = _possibleConstructorReturn(this, (CalcGraphCtrl.__proto__ || Object.getPrototypeOf(CalcGraphCtrl)).call(this, $scope, $injector));
        ...
        _createClass(CalcGraphCtrl, [{
          ...
          value: function issueQueries(datasource) {
            ...
            return _get(CalcGraphCtrl.prototype.__proto__ || Object.getPrototypeOf(CalcGraphCtrl.prototype), 'issueQueries', this).call(this, datasource);
          }
        }, {
          key: 'zoomOut',
        ...
        return CalcGraphCtrl;
      }(MetricsPanelCtrl)));

      _export('CalcGraphCtrl', CalcGraphCtrl);

      _export('PanelCtrl', CalcGraphCtrl);
