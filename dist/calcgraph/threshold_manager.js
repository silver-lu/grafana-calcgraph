...
System.register(['jquery.flot', 'jquery', 'lodash'], function (_export, _context) {
  "use strict";

  var $, _, _createClass, ThresholdManager;
  ...
  return {
    setters: [function (_jqueryFlot) {}, function (_jquery) {
      $ = _jquery.default;
    }, function (_lodash) {
      _ = _lodash.default;
    }],
    execute: function () {
      ...
      _export('ThresholdManager', ThresholdManager = function () {
      ...
      _export('ThresholdManager', ThresholdManager);
    }
  };
});
